...
export class Backend implements backendInterface {
    ...
    async getSummary(arg0: ReportId): Promise<SimplifiedSummary> {
        if (this.processError) {
            try {
    ...
    async submitReport(arg0: string, arg1: string, arg2: Array<string>, arg3: Array<Medication>, arg4: Array<ActionStep>): Promise<ReportId> {
        if (this.processError) {
            try {
